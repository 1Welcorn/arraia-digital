            ...
            <div className="flex-1 flex flex-col p-4 md:p-6 overflow-hidden relative">
              ...
              <div className="flex items-center justify-between gap-4 mb-4 bg-slate-950/30 p-2.5 rounded-2xl border border-slate-800/60 pb-2">
                ...
                <div className="flex items-center gap-3 flex-shrink-0 ml-4">
                  ...
                  }} className="hidden sm:flex items-center gap-1.5 bg-indigo-500/20 text-indigo-400 hover:bg-indigo-500/30 px-3 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer border border-indigo-500/30">
                    <RefreshCw size={14} /> <span className="hidden xl:inline">Trocar Fichas</span>
                  </button>

                  {/* MENU ADMINISTRATIVO DO CAIXA (Substitui o Ordenar Por) */}
                  <div className="relative z-50 flex items-center border-l border-slate-800 pl-4">
                  <button
